...
configs.setup {
  ensure_installed = { "javascript", "c", "embedded_template", "clojure", "cpp", "cuda", "dockerfile", "dot", "rust", "lua", "python", "go", "gomod", "gowork", "graphql", "ruby", "perl", "bash", "fish", "php", "java", "kotlin", "html", "json", "css", "scss", "org", "c_sharp", "todotxt", "typescript", "tsx", "scala", "hcl", "markdown", "toml", "vue", "jsonc", "yaml", "yang", "ninja", "nix", "dart", "rst", "regex", "comment", "svelte", "r", "beancount", "latex", "bibtex", "zig", "cmake", "vim", "json5", "hjson", "http", "make", "proto"}, -- one of "all", "maintained" (parsers with maintainers), or a list of languages
